        ...
        <div class="row">
            ...
            <div class="col-3 d-none d-md-block fondoMorado pantalla sidebar py-5 ps-0">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2 border-start border-warning border-5 ps-3">
                        <a class="link-warning" href="adminCrearProducto.php">
                            <!-- <img class="img-fluid" src="img/icono-Ventas.svg" alt="Logo Lumin" width="40" height="24"> -->
                            <svg class="m-1" style="width:2.5rem;height:2.5rem" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M13 15.6C13.3 15.8 13.7 15.8 14 15.6L19 12.7V13C19.7 13 20.4 13.1 21 13.4V11.6L22 11C22.5 10.7 22.6 10.1 22.4 9.6L20.9 7.1C20.8 6.9 20.7 6.7 20.5 6.6L12.6 2.2C12.4 2.1 12.2 2 12 2S11.6 2.1 11.4 2.2L3.6 6.6C3.4 6.7 3.2 6.8 3.1 7L1.6 9.6C1.3 10.1 1.5 10.7 2 11C2.3 11.2 2.7 11.2 3 11V16.5C3 16.9 3.2 17.2 3.5 17.4L11.4 21.8C11.6 21.9 11.8 22 12 22S12.4 21.9 12.6 21.8L13.5 21.3C13.2 20.7 13.1 20 13 19.3M11 19.3L5 15.9V9.2L11 12.6V19.3M20.1 9.7L13.8 13.3L13.2 12.3L19.5 8.7L20.1 9.7M12 10.8V4.2L18 7.5L12 10.8M20 15V18H23V20H20V23H18V20H15V18H18V15H20Z" />
                            </svg>
            ...
            <div class="col p-0">
                <main class="container mt-2">
                    <form method="post" action ="../API/inventory/nombre/editar">
                    <div class="d-flex justify mt-4 mx-2">
                        <div class="col-12 d-flex flex-column justify-content-start align-items-center">
                            <h1 class="col-12 fw-bold morado">Editar producto</h1>
                            <div class="d-flex flex-column flex-md-row align-items-center">
                                <div class="col-4">
                                    <img src="../img/icono-producto.svg" alt="Imagen Producto" class="img-fluid">
                                </div>
                                <div class="row col-12">
                                    <div class="col-12">
                                        <div class="col-12 col-md-8 order-md-0">
                                            <div class="input my-3">
                                                <label for="Input" class="form-label my-1">Nombre del producto</label>
                                                <input type="text" class="form-control luz border-0 rounded-3" id="Input" name="name_product" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-8 order-md-1">
                                            <div class="input my-3">
                                                <label for="Input" class="form-label my-1">ID del producto: <?php echo $id = $_GET['id'];?></label>
                                                <input type="hidden" class="form-control luz border-0 rounded-3" id="Input" name="id_product" value="<?php echo $id = $_GET['id'];?>" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-8 order-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input btn-morado" type="checkbox" value="" id="flexCheckChecked" name="isAvailable" checked>
                            ...
                            <div class="row col-12 justify-content-center">
                                <div class="col-6 col-md-4">
                                    <div class="input my-3">
                                        <label for="Input" class="form-label my-1">Cantidad</label>
                                        <input type="text" class="form-control luz border-0 rounded-3" id="Input" name="cant_stock" placeholder="">
                                    </div>
                                </div>
                                <div class="col-6 col-md-4">
                                    <div class="input my-3">
                                        <label for="Input" class="form-label my-1">Precio</label>
                                        <input type="text" class="form-control luz border-0 rounded-3" id="Input" name="price"placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row col-12 justify-content-center">
                                <div class="col-12 col-md-4 morado">Categorias:</div>
                                <div class="col-3 col-md-1 px-2 py-1 mx-2 text-center">
                                    <div class="badge rounded-pill bg-warning morado" name="category1">Categoría</div>
                                </div>
                                <div class="col-3 col-md-1 px-2 py-1 mx-2 text-center">
                                    <div class="badge rounded-pill bg-warning morado" name="category2">Categoría</div>
                                </div>
                                <div class="col-3 col-md-1 px-2 py-1 mx-2 text-center">
                                    <div class="badge rounded-pill bg-warning morado" name="category3">Categoría</div>
                                </div>
                            </div>
                            <div class="col-12 col-md-8 form-floating mt-2">
                                <textarea class="form-control" placeholder="Descropcion" id="floatingTextarea2" name="description" style="height: 100px"></textarea>
                                <label for="floatingTextarea2">Descripcion</label>
                            </div>
                            <div class="mt-4 col-8 d-flex justify-content-evenly align-items-center">
                                <input type = "submit" class="btn btn-primary btn-morado" value="Añadir a Inventario">
