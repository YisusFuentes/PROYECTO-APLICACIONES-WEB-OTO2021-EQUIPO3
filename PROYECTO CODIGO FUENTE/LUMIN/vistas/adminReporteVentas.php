        ...
        <div class="row">
            ...
            <div class="col p-0">
                <main class="container mt-2">
                    <h1 class="morado my-3 mb-md-2 mt-md-5 fw-bold">Catalogo</h1>
                    <!-- <div class="col-md-4"> -->
                    <div class="px-3 row justify-content-between align-items-center">
                        <div class="col-12 col-md-6 order-md-0 my-3">
                    ...
                    <div class="container p-0 mt-3" id="cards">
                        ...
                        <div class="row m-0 justify-content-center">
                            ...
                            ?>
                            <div class="col-12 col-md-6 col-lg-5 card luz m-2 py-0 border-0">
                                <div class="card-body">
                                    <div class="row card-title justify-content-start">
                            
                                        <div class="col-6 col-md-12 order-0 m-0">
                                            <h1 class="fw-bold morado m-0"><?php echo "numero de venta: ".$venta->ID_SALE; ?></h1>
                                        </div>
                                        <div class="col-4 col-md-12 order-1 m-0">
                                            <h5 class="my-1 text-muted fw-regular morado"><?php echo "vendedor: ".$venta->TOTAL; ?></h5>
                                        </div>
                            
                                    </div>
                                    <div class="card-info d-flex justify-content-sm-start justify-content-lg-around align-items-center">
                                        <div class="card-info-user m-2 align-middle">
                                            <svg class="d-none d-md-inline morado" style="width:24px;height:24px" viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,6A2,2 0 0,0 10,8A2,2 0 0,0 12,10A2,2 0 0,0 14,8A2,2 0 0,0 12,6M12,13C14.67,13 20,14.33 20,17V20H4V17C4,14.33 9.33,13 12,13M12,14.9C9.03,14.9 5.9,16.36 5.9,17V18.1H18.1V17C18.1,16.36 14.97,14.9 12,14.9Z" />
                                            </svg>
                                            <span style="vertical-align: middle;"><?php echo $venta->USERNAME; ?></span>
        ...
        $(document).ready(() => {
            ...
            for(let i = 0; i < 3; i++){
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                            <div class="card luz mt-3" style="border-radius: 16px; width: 340px;">
                            <div class="card-body">
                                <h1 class="card-title font-weight-bold morado">Poducto</h1>
                                <h5 class="card-subtitle mb-2 text-muted font-weight-normal morado">ID:XXXX</h5>
                                <div class="card-info d-flex justify-content-around align-items-center">
