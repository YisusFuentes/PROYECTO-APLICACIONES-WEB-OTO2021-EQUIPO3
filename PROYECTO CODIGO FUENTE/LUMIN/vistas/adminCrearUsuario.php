        ...
        <div class="row">
            ...
            <div class="col p-0">
                <main class="container mt-2">
                    ...
                    <!-- dirección para conectar al api-->
                    <form action ="../API/users/nombre/nuevo" method= "POST" >
                        <div class="col-12 d-flex flex-column justify-content-start align-items-center">
                            <h1 class="col-12 fw-bold morado">Agregar Usuario</h1>
                            <div class="row col-12 col-md-8 justify-content-center align-items-center">
                            <div class="col-12 col-md-6 input my-3">
                                    <label for="Input" class="form-label my-1">ID de usuario</label>
                                    <input type="text" class="form-control luz border-0 rounded-3" id="Input" name="id" placeholder="Introduce ID">
                                </div>
                                ...
                                <div class="col-12 col-md-6 input my-3">
                                    ...
                                    <input type="text" class="form-control luz border-0 rounded-3" id="Input" name="contraseña" placeholder="Introduce Usuario">
                                </div>
                                <div class="mt-4 col-8 d-flex flex-column flex-md-row justify-content-evenly align-items-center">
                                <input type="submit" value="Agregar" class="btn btn-lg btn-warning fw-bold rounded-pill luz  my-3 px-5"> 
                                 <!-- Me gustaria que regresara, pero no jala los datos jajja, si usas php, se soliciona con un include: configuraciones.php, PARA volver a la pagina anterior
                                  <a href="configuraciones.php" type="submit" class="btn btn-lg btn-warning fw-bold rounded-pill luz  my-3 px-5">Agregar</a> --> 
                                </div>
                            </div>
                        </div>
                        </form>
